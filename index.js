...
(async () => {
    ...
    constructor()
        ...
        this.start = () => {
            this.socket = new WebSocket("wss://gateway-us-east1-c.discord.gg/?v=7&encoding=json");
                    ...
                    if (data.op === this.opcodes.DISPATCH) {
                        if (data.t === "GUILD_UPDATE") {
                            ...
                            if (typeof find?.vanity_url_code === "string" && find.vanity_url_code !== data.d.vanity_url_code) {
                                ...
                                try {
                                    await axios.patch(`https://discord.com/api/v7/guilds/${SNIPER_GUILD_ID}/vanity-url`, {
...
`);
                            ...
                            if (data.t === "READY") {
                                ...
                                await WEBHOOKS.INFO(`Sniping: OS: 1 ${Object.keys(guilds).length}.
